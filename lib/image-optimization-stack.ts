...
var S3_IMAGE_BUCKET_NAME = "original-images-bucket";
var S3_IMAGE_BUCKET_NAME_TRANSFORMED = "transformed-images-bucket";
...
export class ImageOptimizationStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
      ...
      const imageResponseHeadersPolicy = new cloudfront.ResponseHeadersPolicy(
        ...
        `ResponseHeadersPolicy${this.node.addr}`,
        {
          ...
          customHeadersBehavior: {
            customHeaders: [
              {
                header: "x-aws-image-optimization-prod",
                value: "v1.0",
                override: true,
              },
    ...
    new CfnOutput(this, "ImageDeliveryDomainProd", {
